...
<#if isBelowRenewThresold>
    <#if !registry.selfPreservationModeEnabled>
        <h4 id="uptime" style="color: red;"><b>续约低于阀值. 自我保护模式关闭. 对于网络/其他问题，这可能无法保护实例过期.</b></h4>
    <#else>
        <h4 id="uptime" style="color: red;"><b>注意! EUREKA 可能对未启动的实例声称为启动状态. 续约低于阀值并且因此，为了安全，实例不会过期.</b></h4>
    </#if>
<#elseif !registry.selfPreservationModeEnabled>
    <h4 id="uptime" style="color: red;"><b>自我保护模式关闭.对于网络/其他问题，这可能无法保护实例过期.</b></h4>
</#if>
